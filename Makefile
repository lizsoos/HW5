...
SOURCES            = main.c myLib.c game.c text.c font.c apple.c applelandscape.c
CCPATH             = /usr/bin
DKPATH             = /Users/elizabethsoos/Desktop/Lab00_OSX/"Installation Files"/devkitARM/bin
VBASIM             = open /Users/elizabethsoos/Desktop/visualboyadvance-m.app
FIND               = find
COPY               = cp -r
